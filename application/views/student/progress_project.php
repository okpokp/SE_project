...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>cssstd/stylestd.css">
...
<!--<label ><h1>ความคืบหน้าโครงงาน</h1></label><br>&nbsp; -->
						<div class="row">
							<div class="col-sm-4"></div>
							<div class="col-sm-4" style="text-align: center;">
								<label ><h1>ความคืบหน้าโครงงาน</h1></label>
								<label><h2>(Document File)</h2> </label>
							</div>
							<div class="col-sm-4"></div>
						</div>
						<!--//////////////////////////////////////////////////-->
